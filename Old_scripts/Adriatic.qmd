...
#   file = "Data/Model/Chla_GAM_all_10000_Adriatic_log_adapt_delta_97_tree_15_Cleaned_STD2"
# )
...
fit_Adriatic <- brm(
  formula = GeoMean_Chla ~
    ...
    s(sum_Nutri) + s(MLD),
  data = df_wide_Adriatic_STD,
  family = Gamma(student),
  chains = 4, cores = 15,
  iter = 10000,
  warmup = 1000,
  control = list(adapt_delta = 0.97,  max_treedepth = 15),
  file = "Data/Model/Chla_GAM_all_10000_Adriatic_log_adapt_delta_97_tree_15_Cleaned_STD2_FewerVariables"
)
# plot(fit_adriatic)
# summary(fit_Adriatic)

# bayes_R2(fit_Adriatic)
# loo(fit_Adriatic)
### Plots Adriatic
...
plot_Adriatic <- (Adriatic_sst+Adriatic_MLD)/
