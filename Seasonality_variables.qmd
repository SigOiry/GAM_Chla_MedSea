...
fit_SST <- brm(
  SST ~ s(Year, by = Box),
  data = df_wide,
  family = Gamma(link = "log"),  # log link ensures positivity
  chains = 4, cores = 10,
  control = list(adapt_delta = 0.95),
  file = "Data/Model/Environment_Variables/fit_SST_year"
)
...
fit_NPratio <- brm(
  NPratio ~ s(Year, by = Box),
  data = df_wide,
  family = Gamma(link = "log"),  # log link ensures positivity
  chains = 4, cores = 10,
  control = list(adapt_delta = 0.95),
  file = "Data/Model/Environment_Variables/fit_NPratio_year"
)
...
fit_TotalNutrient <- brm(
  TotalNutrient ~ s(Year, by = Box),
  data = df_wide,
  family = Gamma(link = "log"),  # log link ensures positivity
  chains = 4, cores = 10,
  control = list(adapt_delta = 0.95),
  file = "Data/Model/Environment_Variables/fit_TotalNutrient_year"
)
...
fit_PO4 <- brm(
  ...
  chains = 4, cores = 10,
  control = list(adapt_delta = 0.95),
  file = "Data/Model/Environment_Variables/fit_PO4_year"
)
...
fit_NH4 <- brm(
  ...
  chains = 4, cores = 10,
  control = list(adapt_delta = 0.95),
  file = "Data/Model/Environment_Variables/fit_NH4_year"
)
